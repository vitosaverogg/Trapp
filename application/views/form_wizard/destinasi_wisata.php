...
<!-- modal Paris Menara Eiffel -->
<div class="modal fade" tabindex="-1" role="dialog" id="paris">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Paris (Eiffel Tower)</h4>
                    </div>
...
<!-- modal Universal Studio -->
<div class="modal fade" tabindex="-1" role="dialog" id="universal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Universal Studio - Singapore</h4>
                    </div>
...
<!-- modal Bali Indonesia -->
<div class="modal fade" tabindex="-1" role="dialog" id="bali">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Bali - Indonesia</h4>
                    </div>
...
<!-- modal Borobudur -->
<div class="modal fade" tabindex="-1" role="dialog" id="borobudur">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Candi Borobudur - Indonesia</h4>
                    </div>
...
<!-- modal disneyland hongkong -->
<div class="modal fade" tabindex="-1" role="dialog" id="disneyland">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Disneyland - Hongkong</h4>
                    </div>
...
<!-- modal greatwall China -->
<div class="modal fade" tabindex="-1" role="dialog" id="greatwall">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Great Wall - China</h4>
                    </div>
